...
import { bgBox, codeBox, s, slidePage, teal } from "./helper.js";
...
const slideAgenda = slidePage("アジェンダ", () => [
  vspace(4),
  li1("minitype とは"),
  li1("基本的な使い方"),
  li1("スタイルのカスタマイズ"),
...
const slideAbout = slidePage("minitype とは", () => [
  ...
  flexbox(
    [
      bgBox([
        ...
        li1(`${teal("Vite プラグイン")}でブラウザプレビューが可能`),
      ]),
      bgBox([
        p([[b("使用例")]]),
        vspace(2),
...
const slideBasic = slidePage("基本的な使い方", () => [
...
const slideCustom = slidePage("スタイルのカスタマイズ", () => [
...
const slideCodeAndFigure = slidePage("コードブロックと図", () => [
...
const slideSummary = slidePage("まとめ", () => [
...
// slidePage の呼び出し回数が変わったら helper.ts の TOTAL_PAGES も更新すること
export const slides = [
  ...slideAgenda,
  ...slideAbout,
  ...slideBasic,
